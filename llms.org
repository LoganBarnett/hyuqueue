...
~events~ is the source of truth.  The ~items~ and ~topic_data~ tables are
materialized projections.  All state changes (create, ack, refile, LLM
analysis, topic data updates) must be recorded as events.
